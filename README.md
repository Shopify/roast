...
- Filesystem: `~/.local/state/roast/sessions/` (configurable via `XDG_STATE_DIR`)
...
- Config: `$XDG_CONFIG_HOME/roast/initializers/` (default: `~/.config/roast/initializers/`)
- Cache: `$XDG_CACHE_HOME/roast/functions/` (default: `~/.cache/roast/functions/`)
- State: `$XDG_STATE_HOME/roast/sessions/` (default: `~/.local/state/roast/sessions/`)
