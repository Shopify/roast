...
execute(:verify_one) do
  ...
  # zero-confidence verdict so the unit is surfaced as report-only rather than silently counted as
  # correct: a parse failure means we have no verdict, not that the comment is fine.
