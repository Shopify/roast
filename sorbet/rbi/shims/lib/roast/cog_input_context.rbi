...
module Roast
  class CogInputContext
    ...
    #
    #: [T] (Roast::SystemCogs::Call::Output) {(untyped, untyped, Integer) -> T} -> T
    #: (Roast::SystemCogs::Call::Output) -> untyped
    ...
    #
    #: [T] (Roast::SystemCogs::Map::Output) {(untyped, untyped, Integer) -> T} -> Array[T]
    #: (Roast::SystemCogs::Map::Output) -> Array[untyped]
    ...
    # - `from` - Extract output from the execution scope corresponding to a single iteration
    #
    #: [A] (Roast::SystemCogs::Map::Output, ?NilClass) {(A?, untyped, untyped, Integer) -> A} -> A?
    #: [A] (Roast::SystemCogs::Map::Output, ?A) {(A, untyped, untyped, Integer) -> A} -> A
    ...
    #
    #: (Symbol) -> Roast::SystemCogs::Call::Output?
    def call(name); end
    ...
    # - `reduce` - Reduce iteration results to a single value
    #
    #: (Symbol) -> Roast::SystemCogs::Map::Output?
    def map(name); end
    ...
    #
    #: (Symbol) -> Roast::SystemCogs::Repeat::Output?
    def repeat(name); end
    ...
    #
    #: (Symbol) -> Roast::Cogs::Agent::Output?
    def agent(name); end
