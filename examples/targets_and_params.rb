...
execute do
  ruby do |_, params|
    ...
    # e.g., `roast execute dsl/targets_and_params.rb Gemfile Gemfile.lock`
    # or, `roast execute dsl/targets_and_params.rb Gemfile*`
    ...
    # e.g., `roast execute dsl/targets_and_params.rb Gemfile* -- foo=bar abc=pqr hello world`
