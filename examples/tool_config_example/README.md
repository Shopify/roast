...
```bash
cd examples/tool_config_example
bundle exec roast workflow.yml
```

The workflow will demonstrate the tool configuration by attempting to run various commands, showing which ones are allowed and which are rejected based on the configuration.
