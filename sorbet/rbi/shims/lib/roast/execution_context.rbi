...
module Roast
  class ExecutionContext
    ...
    # index as arguments, and executes in a `Roast::CogInputContext` where you can
    ...
    #
    #: () {(untyped, Integer) [self: Roast::CogInputContext] -> untyped} -> void
    ...
    #
    #: (?Symbol?, run: Symbol) ?{(Roast::SystemCogs::Call::Input, untyped, Integer) [self: Roast::CogInputContext] -> untyped} -> void
    ...
    #
    #: (?Symbol?, run: Symbol) {(Roast::SystemCogs::Map::Input, untyped, Integer) [self: Roast::CogInputContext] -> untyped} -> void
    ...
    #
    #: (?Symbol?, run: Symbol) {(Roast::SystemCogs::Repeat::Input, untyped, Integer) [self: Roast::CogInputContext] -> untyped} -> void
    ...
    #
    #: (?Symbol?) {(Roast::Cogs::Ruby::Input, untyped, Integer) [self: Roast::CogInputContext] -> untyped} -> void
