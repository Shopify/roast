  ...
  module SystemCogs
    ...
    class Repeat < SystemCog
      ...
      class Output < Cog::Output
        ...
        # calling `value`, but wrapped in a `Roast::SystemCogs::Call::Output` for use with `from`.
        #
        # #### See Also
        # - `iteration`
        # - `first`
        ...
        #
        # Returns a `Roast::SystemCogs::Map::Output` containing all iterations, which can be used with
      ...
      # @requires_ancestor: Roast::ExecutionManager
      module Manager
        private
