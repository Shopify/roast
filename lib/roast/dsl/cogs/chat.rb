    ...
    module Cogs
      class Chat < Cog
        ...
        class Config < Cog::Config
          field :model, String
          field :api_key, String, ENV["OPENAI_API_KEY"]
          field :base_url, String, ENV["OPENAI_API_BASE_URL"]
          field :provider, Symbol, :openai
          field :assume_model_exists, [TrueClass, FalseClass], false
        end
