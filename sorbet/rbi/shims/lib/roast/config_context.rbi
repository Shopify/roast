...
module Roast
  class ConfigContext
    ...
    # - `no_abort_on_failure!` (alias `continue_on_failure!`) - Continue the workflow even if this cog fails
    #
    #: (?(Symbol | Regexp)?) {() [self: Roast::SystemCogs::Call::Config] -> void} -> void
    ...
    # - `no_abort_on_failure!` (alias `continue_on_failure!`) - Continue the workflow even if this cog fails
    #
    #: (?(Symbol | Regexp)?) {() [self: Roast::SystemCogs::Map::Config] -> void} -> void
    ...
    # - `no_abort_on_failure!` (alias `continue_on_failure!`) - Continue the workflow even if this cog fails
    #
    #: (?(Symbol | Regexp)?) {() [self: Roast::SystemCogs::Repeat::Config] -> void} -> void
    ...
    # - `no_abort_on_failure!` (alias `continue_on_failure!`) - Continue the workflow even if this cog fails
    #
    #: (?(Symbol | Regexp)?) {() [self: Roast::Cogs::Chat::Config] -> void} -> void
    ...
    #
    #: (?(Symbol | Regexp)?) {() [self: Roast::Cogs::Cmd::Config] -> void} -> void
    ...
    # - `no_abort_on_failure!` (alias `continue_on_failure!`) - Continue the workflow even if this cog fails
    #
    #: (?(Symbol | Regexp)?) {() [self: Roast::Cogs::Ruby::Config] -> void} -> void
